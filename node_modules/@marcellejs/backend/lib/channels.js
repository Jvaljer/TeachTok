...
const channels_1 = require("feathers-casl/dist/channels");
function default_1(app) {
    ...
    const caslOptions = (0, channels_1.makeOptions)(app);
    ...
    app.publish((data, context) => {
        ...
        if (app.get('authentication').enabled) {
            ...
            const channels = (0, channels_1.getChannelsWithReadAbility)(app, data, context, caslOptions);
