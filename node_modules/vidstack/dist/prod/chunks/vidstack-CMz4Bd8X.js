import { U as isNull, A as deferredPromise, t as isString, l as listenEvent, R as EventsTarget, D as DOMEvent, r as isArray, a as isNumber } from './vidstack-DoOmgEfT.js';
...
class TextTrack extends EventsTarget {
  ...
  async xe() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import('media-captions'), crossOrigin = this[TextTrackSymbol.al]?.();
...
export { TextTrack as T, appendParamsToURL as a, TextTrackSymbol as b, parseJSONCaptionsFile as c, isCueActive as d, watchCueTextChange as e, findActiveCue as f, getRequestCredentials as g, isTrackCaptionKind as i, loadScript as l, preconnect as p, watchActiveTextTrack as w };
