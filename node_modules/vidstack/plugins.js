...
const unplugin = createUnplugin((options = {}) => {
  let include = options.include ?? defaultIncludePattern, filter = createFilter(include, options.exclude), elements = /* @__PURE__ */ new Set(), styles = /* @__PURE__ */ new Set(), elementsGraph = /* @__PURE__ */ new Map(), stylesGraph = /* @__PURE__ */ new Map(), viteServer = null;
  ...
  function parse(id, code) {
    if (viteServer) {
      const oldElements = elementsGraph.get(id), oldStyles = stylesGraph.get(id), newElements = /* @__PURE__ */ new Set(), newStyles = /* @__PURE__ */ new Set();
  ...
  return {
    ...
    load(id) {
      if (id === bundleModuleId) {
        const imports = [], hasDefaultLayout = elements.has("media-audio-layout") || elements.has("media-video-layout"), hasPlyrLayout = elements.has("media-plyr-layout");
        if (!hasDefaultLayout) {
          imports.push('import "vidstack/player/styles/base.css";');
          for (const style of styles) {
            imports.push(`import "${style}";`);
          }
          const elementClasses = /* @__PURE__ */ new Set();
...
function parseCode(code, elements, styles) {
  let mode = PARSE_MODE_NONE, char = "", buffer = "";
