...
// node_modules/vidstack/dist/dev/chunks/vidstack-DWHAQsPW.js
...
var TextTrack = class extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      import("./dev-PKPEQ6AL.js").then(({ parseText, VTTCue, VTTRegion }) => {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-PKPEQ6AL.js"), crossOrigin = (_a2 = this[TextTrackSymbol._crossOrigin]) == null ? void 0 : _a2.call(this);
  ...
  _readyState() {
    ...
    if (!this.src || this.type !== "vtt") {
      const nativeTrack = (_a2 = this[TextTrackSymbol._native]) == null ? void 0 : _a2.track;
      if (nativeTrack)
...
//# sourceMappingURL=chunk-XWQI47VC.js.map
