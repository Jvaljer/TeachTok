...
const feathers_utils_2 = require("feathers-utils");
...
const refetchItems = (context, params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { items } = (0, feathers_utils_1.getItemsIsArray)(context);
    if (!items) {
        return;
    }
    ...
    (0, feathers_utils_2.markHookForSkip)(authorize_hook_1.HOOKNAME, "all", { params });
...
const checkMulti = (context, ability, modelName, options) => {
    ...
    const currentIsMulti = (0, feathers_utils_2.isMulti)(context);
    if (!currentIsMulti) {
        return true;
    }
